package com.henriquez.personas.Entidades;
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private Context context; //contexto para la pp
    SQLiteDatabase db; //para hacer las operaciones dentro de la red
    ...
    public static DBHelper getIntence(Context ctx){
    ...
    //Genera las tablas y los script necesario
    @Override
    public void onCreate(SQLiteDatabase db) {
        db.execSQL(CREAR_TABLA_USUARIO); //Ejecutamos la sentencia para crear la tabla
    }

    //Cuando se instala, verifica si existe una versión activa
    @Override
